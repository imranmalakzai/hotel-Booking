...
      <button className="group  cursor-pointer flex items-center justify-center gap-2 group 
             bg-black px-4 md:px-7 py-2.5 rounded active:scale-95 transition-all">Subscribe
       <img src={assets.arrowIcon} alt="right_Arrow" className='invert group-hover:translate-x-1.5 transition-all ' />
      </button>
    </div>
