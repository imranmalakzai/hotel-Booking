...
function ListRoom() {
  ...
  return (
    <div>
      <Title align={"left"} title={"Room Listings"} subTitle={"View, edit, or manage all listed rooms. Keep teh information up-t--date to provide the best experience for users. "} />
                   ...
                   {rooms.map((room,index) => (
                    <tr key={index} >
                      ...
                      <td className='py-3 px-4 border-t border-gray-300 text-sm text-red-500 text-center'>
                        <label className='relative inline-flex justify-items-center cursor-pointer text-gray-900 gap-3'>
