...
                   {/* Facebook */}
                   <img src={assets.facebookIcon} alt="facebook_icon" />
                   {/* Twitter */}
                        <img src={assets.twitterIcon} alt="twitter_icon" />
                   {/* LinkedIn */}
                        <img src={assets.linkendinIcon} alt="link " />   
               </div>
           </div>
...
                       {/* Arrow icon */}
                     <img src={assets.arrowIcon} alt="arrowIcons" className='invert' />
                   </button>
               </div>
           </div>
       </div>
